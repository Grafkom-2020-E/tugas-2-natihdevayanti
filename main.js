function main() {
    ...
    quad(9, 10, 11, 8); // DEPAN, merah
    quad(10, 14, 15, 11); // KANAN, hijau
    quad(11, 15, 12, 8); // ATAS, biru
    quad(12, 13, 9, 8); // KIRI, putih
    quad(13, 14, 15, 12); // BELAKANG, oranye
    quad(14, 13, 9, 10); // BAWAH, kuning
